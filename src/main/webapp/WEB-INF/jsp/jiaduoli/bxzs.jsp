...
<div id="Base">
    ...
    <div id="middle">
        ...
        <div class="right">
            <div class='newsList'><img class='smallimage' src='images/upfile/sec6s.jpg'/>
                <p>自燃险</p>
                <div>
                ...
                <a href='news.asp?classid=17&id=70'>More</a></div>
            <div class='newsList'><img class='smallimage' src='images/upfile/sec5s.jpg'/>
                <p>玻璃单独破碎险</p>
                <div>
                    玻璃单独破碎险，车险附加险种。
                    指对车辆的风档玻璃和车窗玻璃发生单独破碎，保险公司负责赔偿。
                </div>
                <a href='news.asp?classid=17&id=69'>More</a></div>
            <div class='newsList'><img class='smallimage' src='images/upfile/sec4s.jpg'/>
                <p>盗抢险</p>
                <div>
                    盗抢险全称是机动车辆全车盗抢险。
                    机动车辆全车盗抢险的保险责任为全车被盗窃、被抢劫、被抢夺造成的车辆损失以及在被盗窃、被抢劫、被抢夺期间受到损坏或车上零部件、附属设备丢失需要修复的合理费用。可见，机动车辆全车盗抢险的保险责任包含两部分：一是因被盗窃、被抢劫、被抢夺造成的保险车辆的损失；二是因保险车
                </div>
                <a href='news.asp?classid=17&id=68'>More</a></div>
            <div class='newsList'><img class='smallimage' src='images/upfile/sec3s.jpg'/>
                <p>第三者责任险</p>
                <div>
                    第三者责任险（简称三责险），全称：机动车第三者责任强制保险。
                    是指保险人允许的合格驾驶员在使用被保险车辆过程中发生的意外事故，致使第三者遭受人身伤亡或财产的直接损失，依法应当由被保险人支付的赔偿金额，保险人会按照保险合同中的有关规定给予赔偿。同时，若经保险公司书面同意，被保险人因此发生仲裁或诉讼费
                </div>
                <a href='news.asp?classid=17&id=67'>More</a></div>
            <div class='newsList'><img class='smallimage' src='images/upfile/sec2s.jpg'/>
                <p>交强险</p>
                <div>
                    ...
                    交强险的全称是“机动车交通事故责任强制保险”，是由保险公司对被保险机动车发生道路交通事故造成受害人（不包括本车人员和被保险人）的人身伤亡、财产损失，在责任限额内予以赔偿的强制性责任保险。交强险是中国首个由国家法律规定实行的强制保险制度。其保费是实行全国统一收
                </div>
                <a href='news.asp?classid=17&id=66'>More</a></div>
            <div class='newsList'><img class='smallimage' src='images/upfile/sec1s.jpg'/>
                <p>车辆损失险</p>
                <div>
                    车辆损失险即车主向保险公司投保的预防车辆可能造成的损失的保险。车辆损失险的保险金额可以按投保时的保险价值或实际价值确定，也可以由投保人与保险公司协商确定，但保险金额不能超出保险价值。即价值10万元的车辆，保险金额只能在10万元以内。
                </div>
                <a href='news.asp?classid=17&id=65'>More</a></div>
            <div class="mCenter" style='text-align:center'><br>共有：<strong>6</strong>条&nbsp;每页显示：<strong>10</strong>条&nbsp;&nbsp;&nbsp;[首页]&nbsp;[上一页]&nbsp;[下一页]&nbsp;[尾页]&nbsp;&nbsp;&nbsp;页次：<strong>1</strong>/1&nbsp;转到:<select
                    name="Page"
                    onchange="javascript:window.location='?ClassID = 17&Page='+this.options[this.selectedIndex].value+'';">
