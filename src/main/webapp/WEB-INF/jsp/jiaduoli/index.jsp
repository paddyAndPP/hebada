...
<head>
    ...
    <style>
        *{font-size:12px;}
        ...
        .show a{display:inline-block; padding:0 110px; float:left;}
    ...
    <div id="middle">
        <div id="left">
            <div class="list" style="padding-bottom:16px;margin-top:0;">
                ...
                <p>厦门和八达贸易有限公司（简称：厦和八达）是一家新崛起的全国连锁型服务机构，总部位于中国福建自由贸易试验区厦门片区（保税港区）。公司实力雄厚，经营业务涵盖了酒店服务、保险、服装、酒水、电子产品等众多行业领域。</p>
                ...
                <table>
                    <tr>
                        ...
                        <td style="overflow:hidden; height:440px; position:relative; vertical-align:top;">
                            <div class="show">
                                <a href='javascript:void(0);'><img src='images/company/product/zuidong.jpg' width="" /><div>醉东</div></a>
                                <a href='javascript:void(0);'><img src='images/company/product/zuinan.jpg' /><div>醉南</div></a>
                                <a href='javascript:void(0);'><img src='images/company/product/zuixi.jpg' /><div>醉西</div></a>
                                <a href='javascript:void(0);'><img src='images/company/product/xo1.jpg' /><div>XO</div></a>
                                <a href='javascript:void(0);'><img src='images/company/product/dahongpao.jpg' /><div>大红袍</div></a>
                            </div>
                        </td>
