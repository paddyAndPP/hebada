...
<body>
    	...
    	<div id="head1">
			<img class="alternate" src="images/store.jpg" />
				...
				<div id="fa-menu">
								...
								<ul id="menu">
									<li>
										<a href="${pageContext.request.contextPath}/" style="padding-left:0;"><img src="images/menu1.jpg" />&nbsp;&nbsp;<span>首页</span></a>
									</li>
									<li>
	...
	<div class="leftMenuContent">
    	<a href='store.asp?classid=11'>泸州老窖<img src='images/arrow1.png' /></a><a href='store.asp?classid=18'>贝秀堡红酒<img src='images/arrow1.png' /></a><a href='store.asp?classid=19'>五粮液<img src='images/arrow1.png' /></a><a href='store.asp?classid=20'>茅台<img src='images/arrow1.png' /></a><a href='store.asp?classid=21'>驾图盒子<img src='images/arrow1.png' /></a><a href='store.asp?classid=22'>荣事达<img src='images/arrow1.png' /></a><a href='store.asp?classid=23'>飞科<img src='images/arrow1.png' /></a><a href='store.asp?classid=24'>堂皇家纺<img src='images/arrow1.png' /></a>
			...
			<div class="right">
				<a href='store.asp?classid=11&id=428' class='store'><img src='images/upfile/11-1.jpg' /><div>珍品青花瓷</div></a><a href='store.asp?classid=11&id=429' class='store'><img src='images/upfile/11-2.jpg' /><div>老窖醇香精品9</div></a><a href='store.asp?classid=11&id=431' class='store'><img src='images/upfile/11-4.jpg' /><div>泸州老窖醇香【佳酿】</div></a><a href='store.asp?classid=11&id=443' class='store'><img src='Images/UpFile/2015628135410741.jpg' /><div>泸州老窖醇香柔和</div></a><a href='store.asp?classid=11&id=456' class='store'><img src='Images/UpFile/201571511857775.jpg' /><div>泸州老窖醇香【K3】</div></a><a href='store.asp?classid=11&id=458' class='store'><img src='Images/UpFile/201571511659506.jpg' /><div>老窖醇香【醇酿珍品】</div></a><a href='store.asp?classid=11&id=488' class='store'><img src='Images/UpFile/2015928145954326.jpg' /><div>泸州老窖醇香【味之尊】</div></a><a href='store.asp?classid=11&id=489' class='store'><img src='Images/UpFile/2015928151346978.jpg' /><div>泸州老窖醇香【典藏】</div></a><a href='store.asp?classid=11&id=490' class='store'><img src='Images/UpFile/2015928151251518.jpg' /><div>泸州老窖醇香【鉴藏】</div></a><a href='store.asp?classid=11&id=509' class='store'><img src='Images/UpFile/2015102794616820.jpg' /><div>泸州老窖醇香【品鉴】 688元</div></a><a href='store.asp?classid=11&id=510' class='store'><img src='Images/UpFile/2015102794842223.jpg' /><div>老窖醇香【尊仕典藏】1288</div></a><a href='store.asp?classid=11&id=511' class='store'><img src='Images/UpFile/20151027111448621.jpg' /><div>泸州老窖【酿艺2014版52度】</div></a><div class='clear'></div><div style='text-align:center'><br>共有：<strong>20</strong>条&nbsp;每页显示：<strong>12</strong>条&nbsp;&nbsp;&nbsp;[首页]&nbsp;[上一页]&nbsp;<a class='c' href="?ClassID = 11&Page=2">[下一页]</a>&nbsp;<a class='c' href="?ClassID = 11&Page=2">[尾页]</a>&nbsp;&nbsp;&nbsp;页次：<strong>1</strong>/2&nbsp;转到:<select name="Page" onchange="javascript:window.location='?ClassID = 11&Page='+this.options[this.selectedIndex].value+'';"><option value="1" selected>1</option><option value="2">2</option></select>&nbsp;&nbsp;<br><br></div>
