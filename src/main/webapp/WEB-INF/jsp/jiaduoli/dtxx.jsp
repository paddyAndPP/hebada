        ...
        <div class="left">
            <div class="leftMenu">
                ...
                <div class="leftMenuContent">
                    <a href='news.asp?classid=16'>��˾����<img src='images/arrow1.png'/></a><a
                        href='news.asp?classid=17'>����֪ʶ<img src='images/arrow1.png'/></a>
                </div>
            </div>
        </div>
        <div class="right">
            <div class='newsList'><img class='smallimage' src='/images/UpFile/image/20161117/20161117133091789178.jpg'/>
                ...
                <div>
                    ...
                    ���ûʼҷġ���Ʒ�ƴ�����1986�꣬רҵ���¼ҷ���ҵ20���꣬�Ⱥ��ٻ��й����Ʋ�Ʒ������������������Ʒ�������й������̱ꡱ��������Ч���Ƚ���ҵ���ȳƺţ�����6�걻��Ϊ������ʡ�����̱�
                </div>
            ...
            <div class="mCenter" style='text-align:center'>
                <br>���У�<strong>26</strong>��&nbsp;ÿҳ��ʾ��<strong>10</strong>��&nbsp;&nbsp;&nbsp;[��ҳ]&nbsp;[��һҳ]&nbsp;<a
                    class='c' href="?Page=2">[��һҳ]</a>&nbsp;<a class='c'
                                                                href="?Page=3">[βҳ]</a>&nbsp;&nbsp;&nbsp;ҳ�Σ�<strong>1</strong>/3&nbsp;ת��:<select
                    name="Page"
