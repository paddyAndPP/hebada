		...
		<div class="navbar" role="navigation">
			<div class="container-fluid container-nav">				
				...
				<ul class="nav navbar-nav navbar-actions navbar-left">
					<li class="visible-md visible-lg"><a href="javascript:void();" id="main-menu-toggle"><i class="fa fa-th-large"></i></a></li>
					<li class="visible-xs visible-sm"><a href="javascript:void();" id="sidebar-menu"><i class="fa fa-navicon"></i></a></li>
				</ul>
				<!-- Navbar Left -->
						...
						<div class="sidebar-menu">						
							<nav id="menu" class="nav-main" role="navigation">
								<ul class="nav nav-sidebar">
									...
									<li>
										<a href="table.html">
											<i class="fa fa-table" aria-hidden="true"></i><span>客户留言</span>
										</a>
									</li>
									<li class="nav-parent">
										<a>
						...
						<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
							<div class="panel bk-widget bk-webkit-fix">
								...
								<div class="panel-body bk-bg-white bk-border-white text-center bk-padding-off">
									<!--<div id="gmap-marker" class="bk-radius-top" style="height: 237px"></div>  delete by templatesy.com (because of google)-->
								</div>
